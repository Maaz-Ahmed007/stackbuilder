import { StackArrows } from "./stackArrows"
    ...
    return (
        <section className="mx-auto max-w-[1440px] px-6 lg:px-20 2xl:px-0 flex flex-col gap-20 py-10 pb-32 md:gap-28 lg:py-20 xl:flex-row relative">
            ...
            <div className="relative z-20 flex flex-1 flex-col items-centers justify-center">
                ...
                <div className="flex flex-row justify-between items-center pt-12 w-full">

                    <StackContainer stackHeading="Experimenting" />
                    <StackContainer />
                    <StackContainer />
                    <StackContainer />
                    ...
                    <StackContainer stackHeading="Testing" />
